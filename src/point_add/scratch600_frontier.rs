...
fn scratch600_frontier_requires_selector_or_parser_breakthrough() {
    ...
    let candidates = [
        ...
        Candidate {
            ...
            blocker: "low-candidate branch-as-final-digit lower bound clears binary lookup by 56386, high_q=low_q+1 on the sample set, and a 23-CCX branch digit toy is Bennett-clean; but the hidden high/low branch is not locally recoverable: exact n14 still has 1068 collisions after granting det-low14, row signs, decoded q sign, step, and low-width/alignment metadata; free neighboring low-alignment lookahead still leaves 4865 n14 / 14160 n16 colliding contexts, even granting neighboring low alignment plus denominator/low widths leaves 4828 n14 / 14191 n16 collisions, and a radius-3 window of full low-branch metadata still leaves 4111 n14 / 21946 n16 collisions. An explicit branch sidecar is not a wire-in either: secp step+low-metadata entropy is p99 109 bits, exact n16 full-local entropy is p99 8 bits, and the peak low-branch schedule already spends 381/381 prefix bits",
        },
        Candidate {
        ...
        Candidate {
            ...
            scratch_bits: 515,
            charged_toffoli: None,
            blocker: "sample plus targeted adversarial slot envelope has only 3 prefix, 3 decoder, and 1 tail high-layer slots; popcount app projects 2345809 mean / 2408100 p99 and static quantum coefficient application projects 2539415 mean / 2612732 p99, but exact toy domains n=8..16 show target rows miss the full slot envelope in 5/5 cases. At n16 the 577-row target set needs 16897 rows with radius exponent 13 to cover exact slots, so the proof family scales exponentially. New CF-spike target rows are a partial repair: they cover all exact toy prefix/decoder slots and fully cover n10/n12 with 1981 rows at n16, but tail slots still have a 2-bit gap. Charging a conservative 8-bit tail already pushes p99 to 2711178, and a one-layer prefix/decoder guard pushes mean to 2715840, so this is not production-charged until the tail envelope has a proof/fallback or a fixed-depth extractor/application circuit exists",
        },
        Candidate {
    ...
    let direct_restoring_final_low_branch_radius_full_high_r3_states_n16 =
        214_960usize;
    let direct_restoring_final_low_branch_branch_sidecar_sample_entropy_p99 = 109usize;
    let direct_restoring_final_low_branch_branch_sidecar_sample_raw_p99 = 117usize;
    let direct_restoring_final_low_branch_branch_sidecar_toy_n16_entropy_p99 = 8usize;
    let direct_restoring_final_low_branch_branch_sidecar_toy_n16_prefix_p99 = 11usize;
    let direct_restoring_final_low_branch_branch_sidecar_toy_mixed_contexts = 1_861usize;
    let direct_restoring_final_low_branch_branch_sidecar_budget_bits = 381usize;
    let direct_restoring_final_low_branch_branch_sidecar_peakfit_bits = 381usize;
    ...
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_rank_table_two_app_gap =
        23_020isize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_sample_choices =
        7_370_995usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k8_collision_keys =
        697usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_keys =
        6_874_430usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_collision_keys =
        0usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_one_roundtrip_floor =
        2 * halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_keys;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_one_roundtrip_gap =
        halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_rank_mean as isize
            + halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_one_roundtrip_floor as isize
            - GOOGLE_LOW_QUBIT_TOFFOLI as isize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane0_keys =
        824_065usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane0_collision_keys =
        75_247usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane1_keys =
        800_896usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane1_collision_keys =
        79_247usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane0_keys =
        1_139usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane0_collision_keys =
        89usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane1_keys =
        1_185usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane1_collision_keys =
        101usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_active_blocks =
        16_152usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_active_masks =
        12_599usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_active_blocks =
        12_701usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_mask_traces =
        4_088usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_traces =
        4_088usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_active_blocks =
        299_013usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_active_masks =
        55_834usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_active_blocks =
        59_445usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_mask_traces =
        42_881usize;
    let halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_traces =
        42_881usize;
    ...
    println!("METRIC scratch600_direct_restoring_final_low_branch_branch_sidecar_sample_entropy_p99={direct_restoring_final_low_branch_branch_sidecar_sample_entropy_p99}");
    println!("METRIC scratch600_direct_restoring_final_low_branch_branch_sidecar_sample_raw_p99={direct_restoring_final_low_branch_branch_sidecar_sample_raw_p99}");
    println!("METRIC scratch600_direct_restoring_final_low_branch_branch_sidecar_toy_n16_entropy_p99={direct_restoring_final_low_branch_branch_sidecar_toy_n16_entropy_p99}");
    println!("METRIC scratch600_direct_restoring_final_low_branch_branch_sidecar_toy_n16_prefix_p99={direct_restoring_final_low_branch_branch_sidecar_toy_n16_prefix_p99}");
    println!("METRIC scratch600_direct_restoring_final_low_branch_branch_sidecar_toy_mixed_contexts={direct_restoring_final_low_branch_branch_sidecar_toy_mixed_contexts}");
    println!("METRIC scratch600_direct_restoring_final_low_branch_branch_sidecar_budget_bits={direct_restoring_final_low_branch_branch_sidecar_budget_bits}");
    println!("METRIC scratch600_direct_restoring_final_low_branch_branch_sidecar_peakfit_bits={direct_restoring_final_low_branch_branch_sidecar_peakfit_bits}");
    ...
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_sample_choices={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_sample_choices}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k8_collision_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k8_collision_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_collision_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_collision_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_one_roundtrip_floor={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_one_roundtrip_floor}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_one_roundtrip_gap={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_one_roundtrip_gap}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane0_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane0_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane0_collision_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane0_collision_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane1_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane1_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane1_collision_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane1_collision_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane0_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane0_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane0_collision_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane0_collision_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane1_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane1_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane1_collision_keys={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane1_collision_keys}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_active_blocks={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_active_blocks}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_active_masks={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_active_masks}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_active_blocks={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_active_blocks}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_mask_traces={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_mask_traces}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_traces={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_traces}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_active_blocks={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_active_blocks}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_active_masks={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_active_masks}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_active_blocks={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_active_blocks}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_mask_traces={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_mask_traces}");
    println!("METRIC scratch600_halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_traces={halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_traces}");
    ...
    assert!(
        direct_restoring_final_low_branch_branch_sidecar_sample_entropy_p99 > 100
            && direct_restoring_final_low_branch_branch_sidecar_sample_raw_p99 > 100
            && direct_restoring_final_low_branch_branch_sidecar_toy_n16_entropy_p99 > 0
            && direct_restoring_final_low_branch_branch_sidecar_toy_n16_prefix_p99 > 0
            && direct_restoring_final_low_branch_branch_sidecar_toy_mixed_contexts > 0
            && direct_restoring_final_low_branch_branch_sidecar_peakfit_bits
                == direct_restoring_final_low_branch_branch_sidecar_budget_bits,
        "explicit high/low branch sidecar now fits as a free low-branch wire-in; revisit branch-as-final-digit integration"
    );
    assert!(
    ...
    assert!(
        halfgcd_second_col_fixed_depth64_full_block_pattern_best_b == 32
            ...
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_sample_choices
                == 7_370_995
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k8_collision_keys
                > 0
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_keys
                == 6_874_430
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_collision_keys
                == 0
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_one_roundtrip_gap
                > 10_000_000
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane0_keys
                == 824_065
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane0_collision_keys
                == 75_247
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane1_keys
                == 800_896
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_k12_lane1_collision_keys
                == 79_247
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane0_keys
                == 1_139
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane0_collision_keys
                == 89
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane1_keys
                == 1_185
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_lookahead_toy_full_lane1_collision_keys
                == 101
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_active_blocks
                == 16_152
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_active_masks
                == 12_599
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_active_blocks
                == 12_701
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_mask_traces
                == 4_088
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_sample_mismatched_traces
                == 4_088
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_active_blocks
                == 299_013
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_active_masks
                == 55_834
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_active_blocks
                == 59_445
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_mask_traces
                == 42_881
            && halfgcd_second_col_fixed_depth64_full_block_pattern_endpoint_dp_jsf_toy_mismatched_traces
                == 42_881
